...
class JSignedLeftShiftOp extends JBinaryExpression {
	public JSignedLeftShiftOp(int line, JExpression lhs, JExpression rhs) {
		super(line, "<<", lhs, rhs);
	}
...
class JSignedRightShiftOp extends JBinaryExpression {
	public JSignedRightShiftOp(int line, JExpression lhs, JExpression rhs) {
		super(line, ">>", lhs, rhs);
	}
