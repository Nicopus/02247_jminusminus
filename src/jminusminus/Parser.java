...
public class Parser {
    ...
    private JInterfaceDecleration interfaceDecleration(ArrayList<String> mods) {
		...
		return new JInterfaceDecleration(line, mods, name, superClass, interfaceBody());
	}
	 ...
	 * <pre>
	 * // level 12
	 * conditionalExpression ::= conditionalOrExpression [CONDITIONAL assignmentExpression COL conditionalExpression]
	 * <pre>
	 * 
     ...
     * 		conditionalAndExpression { LOR conditionalAndExpression }
     * <pre>
     * 
     * @return
     */
	 ...
	 * exclusiveOrExpression {B_OR exclusiveOrExpression}
	 * <pre>
	 * 
	 ...
	 * andExpression {B_XOR andExpression}
	 * <pre>
	 * 
	 * @return
	 */
     ...
     * 	// level 4
	 *  shiftExpression ::= 
     *  additiveExpression {(SL_SHIFT< | SR_SHIFT | UR_SHIFT) additiveExpression}
     * <pre>
 	 *
