...
class JMethodDeclaration
    ...
    protected ArrayList<TypeName> throwsIdents;
    ...
    public JMethodDeclaration(int line, ArrayList<String> mods,
        ...
        ArrayList<JFormalParameter> params, JBlock body, ArrayList<TypeName> throwsIdents)

    {
        ...
        this.throwsIdents = throwsIdents;
    }
    ...
    public void writeToStdOut(PrettyPrinter p) {
        ...
        if (throwsIdents != null) {
            p.println("<ThrowIdentifiers>");
            for (TypeName ident : throwsIdents) {
                p.indentRight();
